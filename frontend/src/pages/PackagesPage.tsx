  ...
  return (
    <AnimatedSection className="mt-12">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="inline-flex w-fit rounded-full bg-pearl px-4 py-2 text-sm font-medium text-ink/70">
      ...
      {items.length > 0 ? (
        ...
        <div className="rounded-[28px] border border-dashed border-black/10 bg-white px-6 py-10 text-sm text-ink/55">
...
export function PackagesPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {loading ? (
        <AnimatedSection className="mt-12">
          <div className="rounded-[32px] border border-black/5 bg-white p-8 text-sm text-ink/60 shadow-soft">
